  ...
  const getAvailableSlots = async() =>{
   ...
   for (let i = 0; i < 7; i++){
      ...
      while(currentDate < endTime){
        ...
        //incrementy current time by 30 minutes
  ...
  return docInfo && (
    <div>
       ...
       <div className='sm:ml-72 sm:pl-4 mt-4 font-medium text-gray-700'>
        ...
        <button  className='bg-primary text-white text-sn font-light px-14 py-3 rounded-full my-6'>Book an appointment</button>
       </div>
